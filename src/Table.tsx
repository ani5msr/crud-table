...
import { Button, PageButton } from './component/Button'
import { classNames } from './component/Util'
import { SortIcon, SortUpIcon, SortDownIcon } from './component/Icons'
...
interface Props {
  ...
  export const StatusPill: React.FC<Props> = ({ value }) => {
  ...
  export const EditCell: React.FC<EditProps> = ({ row }) => {
    return (
      <div>
  ...
  interface AvatarCellProps {
    ...
    export function AvatarCell({ value, column, row }: AvatarCellProps) {
    return (
